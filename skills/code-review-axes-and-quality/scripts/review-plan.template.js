...
//
// Copy this file into .agents/plans/, fill in the constants and scope, then
// run it in a Code Execution block. On resume, update DONE_IDS only after
// inspecting and validating the durable axis files.
// ============================================================================
...
## Project context
Stack: <language, framework, database, runtime, test/lint commands>
Review scope: <working tree, feature, commit range, or module>
Relevant rules and memory: <paths and concise scope notes>
Relevant files: <paste the file list and any diff/stat context>
`;
